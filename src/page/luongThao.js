    ...
    <div className='over' >
      ...
      >
        <div className='modal__content'>
          ...
          <p className='modal__des'>STK đây nha: 0491000160890</p>
          <p className='modal__des'>Ngân hàng: VCB bank</p>
          {/* <p className='modal__des'>Chủ tài khoản: Nguyễn Trung Phong</p> */}
        </div>
      </Modal>
    </div>
  );
